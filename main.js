...
async function bot(fn, message) {
  ...
  if (isMedia) {
    ...
    if (mimetype == 'image/gif') {
      ...
      await fn.sendMp4AsSticker(from, videoBase64, {fps: 10, startTime: '00:00:00.0', endTime : '00:00:05.0', loop: 0}, {discord: "568919637366931460", author: 'FN', keepScale: true, pack: 'FNBots'})
    } else
